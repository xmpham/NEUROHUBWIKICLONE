...
**_For instructions on how to acknowledge NeuroHub and/or UK Biobank in publications and other work, please refer to section [6.0 - Acknowledgments](https://github.com/neurohub/neurohub_documentation/wiki/6.0-Acknowledgements)._**